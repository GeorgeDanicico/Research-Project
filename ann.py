...
from dataset import get_image_classifier_dataset_test, get_image_classifier_dataset_train
...
train_loader = DataLoader(get_image_classifier_dataset_train(), batch_size=batch_size, shuffle=True, num_workers=4)
...
test_loader = DataLoader(get_image_classifier_dataset_test(), batch_size=batch_size, shuffle=False, num_workers=4)
...
def train(num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        # Print the metrics
        print("Epoch {}, Train Accuracy: {} , TrainLoss: {} , Test Accuracy: {}".format(epoch, train_acc,
                                                                                        train_loss, test_acc))
